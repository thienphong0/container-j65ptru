...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j65ptru.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j65ptru.containers.anotherwebservice.com/
...
```
git clone git@github.com:thienphong0/container-j65ptru.git
cd container-j65ptru
```
...
```
docker attach container-j65ptru
```
